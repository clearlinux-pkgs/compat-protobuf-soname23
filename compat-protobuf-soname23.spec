...
Requires: compat-protobuf-soname23-lib = %{version}-%{release}
Requires: compat-protobuf-soname23-license = %{version}-%{release}
...
%package lib
Summary: lib components for the compat-protobuf-soname23 package.
Group: Libraries
Requires: compat-protobuf-soname23-license = %{version}-%{release}

%description lib
lib components for the compat-protobuf-soname23 package.


%package license
Summary: license components for the compat-protobuf-soname23 package.
Group: Default

%description license
license components for the compat-protobuf-soname23 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641985261
...
export SOURCE_DATE_EPOCH=1641985261
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-protobuf-soname23
cp %{_builddir}/protobuf-3.12.4/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname23/1b5a14d06dd784e88dadc5c68344be2dc13875b6
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname23/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname23/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname23/5a2314153eadadc69258a9429104cd11804ea304
%make_install
## Remove excluded files
rm -f %{buildroot}*/usr/lib/python3.10/*
...
/usr/share/package-licenses/compat-protobuf-soname23/1b5a14d06dd784e88dadc5c68344be2dc13875b6
/usr/share/package-licenses/compat-protobuf-soname23/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
/usr/share/package-licenses/compat-protobuf-soname23/5a2314153eadadc69258a9429104cd11804ea304
